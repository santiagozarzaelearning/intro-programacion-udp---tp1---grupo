...
for i in range (10 - 1):
    ...
    capacidadTotalFilial = int(input("Ingrese la capacidad maxima de huespedes de la filial: "))
    ...
    # Validaciones 
    if capacidadTotalFilial <= 0 or cantHabitaciones <= 0 or cantHuespedesMes <= 0:
